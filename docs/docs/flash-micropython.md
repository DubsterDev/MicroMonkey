...
![Screenshot of the command palette with "Flash MicroPython" selected](./images/selecting-flash-micropython.png)
<small>The command palette with "Flash MicroPython" selected</small>
...
![Screenshot of the flashing process](./images/flashing-micropython.png)
<small>Flashing MicroPython to a ESP32</small>
